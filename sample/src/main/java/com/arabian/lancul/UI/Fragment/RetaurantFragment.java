...
public class RetaurantFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        restaurants.add(new Restaurant("Homeros | وجبة لذيذة","Dubai","https://lh3.googleusercontent.com/a-/AOh14Gi0oykjWSvXqX7tQlsh9iZEa_2_sv2Utl5CM4Xa=s96-cc-rg",(float)4.5));
